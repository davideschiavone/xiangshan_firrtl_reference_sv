...
module Queue2_TLBundleD_17_reference(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  input  [7:0] io_enq_bits_data,	// src/main/scala/chisel3/util/Queue.scala:72:14
  ...
  output [7:0] io_deq_bits_data,	// src/main/scala/chisel3/util/Queue.scala:72:14
  ...
  ram_2x10_reference ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:91
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_denied, io_enq_bits_data, io_enq_bits_corrupt})	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  assign io_deq_bits_denied = _ram_ext_R0_data[9];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_data = _ram_ext_R0_data[8:1];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
