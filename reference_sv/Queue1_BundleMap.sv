...
module Queue1_BundleMap_reference(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  input  [5:0] io_enq_bits_tl_state_source,	// src/main/scala/chisel3/util/Queue.scala:72:14
  ...
  output [5:0] io_deq_bits_tl_state_source	// src/main/scala/chisel3/util/Queue.scala:72:14
);

  reg  [9:0] ram;	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  assign io_deq_bits_tl_state_size = ram[9:6];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_tl_state_source = ram[5:0];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
endmodule
