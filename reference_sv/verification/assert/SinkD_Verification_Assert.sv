  ...
  `ifndef SYNTHESIS	// home/davide/gitdir/bianco/XiangShan/huancun/src/main/scala/huancun/SinkD.scala:55:9
    always @(posedge SinkD.clock) begin	// home/davide/gitdir/bianco/XiangShan/huancun/src/main/scala/huancun/SinkD.scala:27:7, :55:9
      if (~SinkD.reset & ~(SinkD._io_bs_waddr_bits_noop_T | SinkD._io_d_ready_T | SinkD.io_d_bits_size == 3'h6)) begin	// home/davide/gitdir/bianco/XiangShan/huancun/src/main/scala/huancun/SinkD.scala:27:7, :28:14, :55:{9,10,22,25,35,53}
        if (`ASSERT_VERBOSE_COND_)	// home/davide/gitdir/bianco/XiangShan/huancun/src/main/scala/huancun/SinkD.scala:55:9
          $error("Assertion failed: SinkD must receive aligned message when needData\n");	// home/davide/gitdir/bianco/XiangShan/huancun/src/main/scala/huancun/SinkD.scala:55:9
        if (`STOP_COND_)	// home/davide/gitdir/bianco/XiangShan/huancun/src/main/scala/huancun/SinkD.scala:55:9
          $fatal;	// home/davide/gitdir/bianco/XiangShan/huancun/src/main/scala/huancun/SinkD.scala:55:9
      end
    end // always @(posedge)
