...
module Queue2_AXI4BundleR_reference(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  ram_2x273_reference ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:91
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_id, io_enq_bits_data, io_enq_bits_resp, io_enq_bits_last})	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  assign io_deq_bits_id = _ram_ext_R0_data[272:259];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_data = _ram_ext_R0_data[258:3];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_resp = _ram_ext_R0_data[2:1];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
