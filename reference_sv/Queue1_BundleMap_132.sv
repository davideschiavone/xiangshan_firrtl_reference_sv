...
module Queue1_BundleMap_132_reference(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  input  [12:0] io_enq_bits_extra_id,	// src/main/scala/chisel3/util/Queue.scala:72:14
  input         io_enq_bits_real_last,	// src/main/scala/chisel3/util/Queue.scala:72:14
  ...
  output [12:0] io_deq_bits_extra_id,	// src/main/scala/chisel3/util/Queue.scala:72:14
  output        io_deq_bits_real_last	// src/main/scala/chisel3/util/Queue.scala:72:14
);

  reg  [13:0] ram;	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  always @(posedge clock) begin	// src/main/scala/chisel3/util/Queue.scala:60:7
    if (do_enq)	// src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
      ram <= {io_enq_bits_extra_id, io_enq_bits_real_last};	// src/main/scala/chisel3/util/Queue.scala:73:91
  end // always @(posedge)
  ...
  assign io_deq_bits_extra_id = ram[13:1];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_real_last = ram[0];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
endmodule
